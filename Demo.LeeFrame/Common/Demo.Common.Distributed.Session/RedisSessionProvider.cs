...
namespace Demo.Common.Distributed.Session {
     ...
     web.config 配置
       ...
       <appSettings> 
        ...
        <system.web> 
            ...
            <sessionState mode="Custom" customProvider="RedisSessionProvider" sessionIDManagerType="YiGuanPro.Shop.Distributed.Session.RedisSessionIDManager">
                <providers>
                <add name="RedisSessionProvider" type="YiGuanPro.Shop.Distributed.Session.RedisSessionProvider,YiGuanPro.Shop.Distributed.Session"/>
                </providers>
            </sessionState> 
        </system.web>
    ...
    public class RedisSessionProvider: SessionStateStoreProviderBase {
        ...
        public override void Initialize(string name, NameValueCollection config) {
            ...
            _connectionMultiplexer = RedisHelper.connection;
