...
namespace Demo.Common.Reflection
{
    ...
    public static class InstanceActivator
    {
        ...
        /// <param name="args">
        ///     An array of arguments that match in number, order, and type the parameters of the constructor to
        ///     invoke. If <paramref name="args" /> is an empty array or null, the constructor that takes no parameters (the
        ...
        /// <returns>A reference to the newly created object.</returns>
        [SecurityPermission(SecurityAction.Demand, Unrestricted = true)]
        public static object CreateInstance(string assemblyFile, string typeFullName, bool ignoreCase,
            params object[] args)
        {
            var type = TypeLoader.Load(assemblyFile, typeFullName, ignoreCase);
        ...
        /// <returns>A reference to the newly created object.</returns>
        [SecurityPermission(SecurityAction.Demand, Unrestricted = true)]
        public static object CreateInstanceFrom(string assemblyFile, string typeFullName, bool ignoreCase,
            params object[] args)
        {
            var type = TypeLoader.LoadFrom(assemblyFile, typeFullName, ignoreCase);
        ...
        [SecurityPermission(SecurityAction.Demand, Unrestricted = true)]
        public static object CreateInstance(string assemblyFile, string typeFullName, bool ignoreCase,
            Type[] typeArguments, params object[] args)
        {
            object result = null;

            var genericType = TypeLoader.Load(assemblyFile, typeFullName, ignoreCase).MakeGenericType(typeArguments);
            ...
            Type[] typeArguments, params object[] args)
        {
            ...
            var genericType = TypeLoader.LoadFrom(assemblyFile, typeFullName, ignoreCase).MakeGenericType(typeArguments);
        ...
        /// </param>
        /// <returns>A reference to the newly created object.</returns>
        public static T CreateInstance<T>(string assemblyFile, string typeFullName, bool ignoreCase,
            params object[] args)
        {
        ...
        /// </param>
        /// <returns>A reference to the newly created object.</returns>
        public static T CreateInstanceFrom<T>(string assemblyFile, string typeFullName, bool ignoreCase,
            params object[] args)
        {
