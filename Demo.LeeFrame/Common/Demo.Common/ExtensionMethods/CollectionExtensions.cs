...
namespace Demo.Common.ExtensionMethods
{
    ...
    public static class CollectionExtensions
    {
        ...
        /// <summary>
        ///     Gets the value associated with the specified key, if the key is found; otherwise, the default value for the type of
        ///     the value parameter.
        /// </summary>
        ...
        /// <summary>
        ///     Gets the value associated with the specified key, if the key is found; otherwise, create a value, add it to the
        ...
        /// <summary>
        ///     Searches for all elements that matches the conditions defined by the specified predicate, and returns the
        ///     zero-based index of the all occurrence within the entire System.Collections.Generic.List{T}.
        /// </summary>
        ...
        /// <returns>
        ///     A list of the zero-based index of the all occurrence of elements that matches the conditions defined by match,
        ///     if found; otherwise, empty list.
        /// </returns>
        ...
        /// <summary>
        ///     Returns a list of IEnumerable{T} that contains the sub collection of source that are delimited by elements of a
        ///     specified predicate.
        ...
        /// <summary>
        ///     Returns a list of IEnumerable that contains the sub collection of source that are delimited by elements of a
        ///     specified predicate.
        ///     The elements of each sub collection are started with the specified predicate element.
        /// </summary>
        /// <param name="source">Source IEnumerable.</param>
