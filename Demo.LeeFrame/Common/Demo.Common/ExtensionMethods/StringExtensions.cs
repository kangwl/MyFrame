...
namespace Demo.Common.ExtensionMethods
{
    /// <summary>
    ///     String Extensions.
    /// </summary>
    public static class StringExtensions
    {
        ...
        /// <returns>
        ///     The list of index positions of the value parameter if that string is found, or empty list if it is not. If
        ///     value is System.String.Empty or null, the return value is empty list.
        /// </returns>
        ...
        /// <param name="ignoreCase">true to ignore case when comparing the string to seek; otherwise, false.</param>
        /// <returns>
        ///     true if the <paramref name="value" /> parameter occurs within this string, or if <paramref name="value" /> is
        ///     the empty string ("") or null; otherwise, false.
        /// </returns>
        ...
        /// <returns>
        ///     true if the <paramref name="values" /> parameter occurs within this string, or if <paramref name="values" />
        ...
        /// <summary>
        ///     Returns a new string in which all occurrences of a specified string in this instance are replaced with another
        ///     specified string.
        /// </summary>
        /// <param name="source">Source string.</param>
        ...
        ///     A System.Boolean indicating a case-sensitive or insensitive comparison. (true indicates a
        ...
        /// <summary>
        ///     Returns a new string in which all occurrences of a specified char in this instance are replaced with another
        ///     specified char.
        /// </summary>
        /// <param name="source">Source string.</param>
        ...
        public static string Replace(this string source, char oldValue, char newValue, bool ignoreCase)
        {
            ...
            var oldValueLength = oldString.Length;
            var newString = newValue.ToString();
            var newValueLength = newString.Length;
            var index = 0;
        ...
        /// <summary>
        ///     Returns a new string in which all occurrences of a specified strings in this instance are replaced with another
        ///     specified string.
        /// </summary>
        /// <param name="source">Source string.</param>
        ...
        /// <summary>
        ///     Returns a new string in which all occurrences of a specified chars in this instance are replaced with another
        ///     specified char.
        /// </summary>
        /// <param name="source">Source string.</param>
        ...
        /// <summary>
        ///     Deletes all the character from this string beginning at a specified position and continuing through the last
        ///     position.
        /// </summary>
        /// <param name="source">Source string.</param>
        ...
        /// <summary>
        ///     Deletes all the characters from this string beginning at a specified position and continuing through the last
        ///     position.
        /// </summary>
        /// <param name="source">Source string.</param>
        /// <param name="ignoreCase">
        ...
        /// <param name="source">The string to test.</param>
        /// <returns>
        ///     true if the <paramref name="source" /> parameter is null or <see cref="F:System.String.Empty" />, or if
        ///     <paramref name="source" /> consists exclusively of white-space characters.
        /// </returns>
        ...
        public static string ExtractChars(this string source, Func<char, bool> predicate)
        {
            ...
            return
                source.Where(predicate)
                    .Aggregate(new StringBuilder(source.Length), (stringBuilder, item) => stringBuilder.Append(item))
                    .ToString();
        }
        ...
        public static string LeftSubstringIndexOf(this string source, string value, bool ignoreCase = false)
        {
            ...
            var index = ignoreCase ? source.IndexOf(value, StringComparison.OrdinalIgnoreCase) : source.IndexOf(value);
        ...
        /// <summary>
        ///     Retrieves left part substring from this instance. The substring ends at the last occurrence of the specified string
        ///     position. If the specified string is not found, the return value is <see cref="F:System.String.Empty" />.
        /// </summary>
        /// <param name="source">Source string.</param>
        /// <param name="value">The string to seek.</param>
        /// <param name="ignoreCase">true to ignore case when comparing the string to seek; otherwise, false.</param>
        ...
        /// <summary>
        ///     Retrieves right part substring from this instance. The substring starts at the first occurrence of the specified
        ///     string position. If the specified string is not found, the return value is <see cref="F:System.String.Empty" />.
        /// </summary>
        /// <param name="source">Source string.</param>
        /// <param name="value">The string to seek.</param>
        ...
        /// <summary>
        ///     Retrieves right part substring from this instance. The substring starts at the last occurrence of the specified
        ///     string position. If the specified string is not found, the return value is <see cref="F:System.String.Empty" />.
        /// </summary>
        /// <param name="source">Source string.</param>
        /// <param name="value">The string to seek.</param>
        ...
        public static List<string> SplitNested(this string source, char delimiter = ' ', char qualifier = '"')
        {
            ...
            for (var i = 0; i < source.Length; i++)
            {
                ...
                {
                    if (character == qualifier &&
                        ((source.Length > i + 1 && source[i + 1] == delimiter) || (i + 1 == source.Length)))
                    {
                        inQuotes = false;
                        inItem = false;
                        i++;
        ...
        public static List<string> SplitNested(this string source, char[] delimiters, char qualifier = '"')
        {
            ...
            for (var i = 0; i < source.Length; i++)
            {
                ...
                {
                    if (character == qualifier &&
                        ((source.Length > i + 1 && delimiters.Contains(source[i + 1])) || (i + 1 == source.Length)))
                    {
                        inQuotes = false;
                        inItem = false;
                        i++;
        ...
        /// <summary>
        ///     Escapes a minimal set of characters (\, *, +, ?, |, {, [, (,), ^, $,., #, and white space) by replacing them with
        ///     their escape codes. This instructs the regular expression engine to interpret these characters literally rather
