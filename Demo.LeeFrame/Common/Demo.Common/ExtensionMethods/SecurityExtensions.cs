...
namespace Demo.Common.ExtensionMethods
{
    ...
    public static class SecurityExtensions
    {
        ...
        /// <param name="fOAEP">
        ///     true to perform direct RSA encryption using OAEP padding (only available on a computer running
        ///     Microsoft Windows XP or later); otherwise, false to use PKCS#1 v1.5 padding.
        /// </param>
        ...
        public static byte[] EncryptRSA(this byte[] source, string key = null, bool fOAEP = false)
        {
            ...
            using (var rsa = new RSACryptoServiceProvider(new CspParameters {KeyContainerName = key ?? string.Empty}))
            {
        ...
        /// <summary>
        ///     Computes the hash value of the specified byte array using SHA512Managed algorithm, and signs the resulting hash
        ///     value.
        /// </summary>
