...
namespace Demo.Common.ExtensionMethods
{
    ...
    public static class EnumExtensions
    {
        ...
        public static TEnum ToEnum<TEnum>(this string source, TEnum defaultValue = default(TEnum),
            bool ignoreCase = false, bool throwOnError = false) where TEnum : struct
        {
            try
            {
        ...
        /// <summary>
        ///     If the specified Enum has a System.ComponentModel.DescriptionAttribute defined, the defined description is
        ///     returned. Otherwise call ToString() on the Enum value.
        /// </summary>
        ...
        /// <param name="source">Source enum.</param>
        /// <returns>
        ///     A list of the values of the constants in enumType. The elements of the array are sorted by the binary values
