...
namespace ConsoleApp.JuHe.SMS
{
    class Program
    {
        static void Main(string[] args)
        {
            JuHeSMS.SendVerifyCode(code: VerifyCodeMaker.GetCodePureNumber());
    ...
    {
        public static string GetCodePureNumber(int len = 4)
        {
            return RandomHelper.CreateNumberStr(4);
        }
    }

    public class JuHeSMS
    {
        public static void SendVerifyCode(string mobilephone = "15869165949", string code = "3112")
        {
            string appkey = "aedd4ae51dd858de86a4b0bc48902a67"; //配置您申请的appkey
            ...
            parameters2.Add("tpl_id", "21611"); //短信模板ID，请参考个人中心短信模板设置
            string sCode = HttpUtility.UrlEncode("#code#=" + code);
            parameters2.Add("tpl_value", sCode); //变量名和变量值对。如果你的变量名或者变量值中带有#&amp;=中的任意一个特殊符号，请先分别进行urlencode编码后再传递，&lt;a href=&quot;http://www.juhe.cn/news/index/id/50&quot; target=&quot;_blank&quot;&gt;详细说明&gt;&lt;/a&gt;
