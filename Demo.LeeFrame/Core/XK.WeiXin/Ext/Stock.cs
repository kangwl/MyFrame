...
namespace XK.WeiXin.Ext {
    public class Stock {
        ...
        public string SaveStock(string startWords) {
           ...
           // log.WriteLog("223sdd");
            ...
            try {
                ...
                JsonHelper<StockModel>.Serialize2File(stockModel, JsonPath);
        ...
        public string RemoveStock(string startWords) {
            ...
            StockModel stockModel = JsonHelper<StockModel>.DeserializeFromFile(JsonPath);
        ...
        private string GetWebreq(string reqUrl) {
            HttpWebHelper webHelper = new HttpWebHelper(reqUrl);
