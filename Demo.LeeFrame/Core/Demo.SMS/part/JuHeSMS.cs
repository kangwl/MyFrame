...
namespace Demo.SMS
{
    ...
    {
        public JuHeSMS(string mobileNO, string verifyCode)
        {
            MobileNO = mobileNO;
        ...
        public bool SendVerifyCode()
        {
            ...
            parameters2.Add("mobile", MobileNO); //接收短信的手机号码
            parameters2.Add("tpl_id", "21611"); //短信模板ID，请参考个人中心短信模板设置
            string sCode = HttpUtility.UrlEncode("#code#=" + VerifyCode);
            parameters2.Add("tpl_value", sCode);
            ...
            else
            {
                ...
                Log log = new Log();
                log.WriteLog(newObj2["error_code"].Value + ":" + newObj2["reason"].Value);
                return false;
            }
        }
